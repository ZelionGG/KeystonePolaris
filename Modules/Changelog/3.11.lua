...
KeystonePolaris.Changelog["3.11"] = {
    ...
    header = {
        ...
        ["enUS"] = {
            ...
            text = "Version 3.11 introduces [Milestones]: custom checkpoints with zone/subzone triggers, main display text, completion feedback, and [Progress Bar] tick markers. This update also prepares the Midnight Mythic+ season 2 dungeon pool (start date TBD), refreshes season 2 default routes from PTR data, supports TBD season dates, and fixes the minimap icon tooltip.",
        },
        ["frFR"] = {
            ...
            text = "La version 3.11 ajoute les [Milestones] : points de contrôle personnalisés avec déclencheurs de zone/sous-zone, texte sur l'affichage principal, retour de complétion et repères sur la [Barre de progression]. Cette mise à jour prépare aussi le pool de donjons Midnight Mythique+ saison 2 (date de début à confirmer), met à jour les routes S2 par défaut depuis les données PTR, prend en charge les dates de saison TBD, et corrige l'infobulle de l'icône de minimap.",
        },
        ["koKR"] = {},
        ["ruRU"] = {},
        ["deDE"] = {},
