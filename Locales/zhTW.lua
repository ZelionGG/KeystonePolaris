...
-- TODO: L["INFORM_GROUP_SUFFIX"] = "Text After Percentage"
-- TODO: L["INFORM_GROUP_SUFFIX_DESC"] = "Optional custom text appended after the percentage in the inform message. Example: before Catacombs"
