...
L["MODULES_SUMMARY_LIVE_ROUTE_DESC"] = "Share your route with other Keystone Polaris players in Mythic or Mythic+ dungeons, without overwriting their saved Custom Routes."
...
L["COMMANDS_HELP_SHARE"] = "/kpl share or /polaris share - Share your route with the group"
L["COMMANDS_HELP_UNFOLLOW"] = "/kpl unfollow or /polaris unfollow - Stop following a shared route"
...
-- Live Route Sharing
L["KPL_LR_HEADER"] = "Live Route Sharing"
L["KPL_LR_DESC_LONG"] = "Share your Keystone Polaris route with the group in Mythic or Mythic+ dungeons. Following a route never overwrites your saved Custom Routes. Blizzard blocks addon messages after the keystone starts: share before starting the key, or after the run."
L["KPL_LR_SHARE"] = "Share"
L["KPL_LR_SHARE_WITH"] = "Share with: %s"
L["KPL_LR_UNFOLLOW"] = "Unfollow"
L["KPL_LR_FOLLOWING"] = "Following %s's route. %s"
L["KPL_LR_UNFOLLOWED"] = "Stopped following the shared route."
L["KPL_LR_NOT_FOLLOWING"] = "You are not following a shared route."
L["KPL_LR_SHARED"] = "Route shared with the group."
L["KPL_LR_FOLLOWER_ACCEPTED"] = "%s is following your route."
L["KPL_LR_QUEUED"] = "Queued %s's route for %s. You'll be asked when you enter the dungeon."
L["KPL_LR_DECODE_FAILED"] = "Received a route that could not be read."
L["KPL_LR_NO_PEERS"] = "Nobody else has Keystone Polaris."
L["KPL_LR_NOT_IN_DUNGEON"] = "Share is only available in Mythic or Mythic+ dungeons."
L["KPL_LR_IN_COMBAT"] = "Wait until after combat to share a route."
L["KPL_LR_COMM_LOCKDOWN"] = "Blizzard blocks addon messages during an active Mythic+ run. Share the route before starting the keystone, or after the run."
L["KPL_LR_COOLDOWN"] = "Wait %d seconds before sharing again."
L["KPL_LR_SHARE_WHILE_FOLLOWING"] = "Unfollow the current route before sharing yours."
L["KPL_LR_DISABLED"] = "Live Route Sharing is disabled in options."
L["KPL_LR_ENCODE_FAILED"] = "Could not encode the route to share."
L["KPL_LR_SEND_FAILED"] = "Could not send the route to the group."
L["KPL_LR_PROMPT"] = "%s wants to share a Keystone Polaris route for %s. Follow this route?"
L["KPL_LR_REPLACE_PROMPT"] = "%s wants to replace %s's route for %s. Follow this route?"
L["KPL_LR_ALWAYS_ASK"] = "Always ask before following a route"
L["KPL_LR_ALWAYS_ASK_DESC"] = "When enabled, even routes from the tank or group leader require confirmation."
L["KPL_LR_CHAT_COMMAND_INFO"] = "Tip: use |cffffd100/kpl share|r or |cffffd100/polaris share|r to share your route, and |cffffd100/kpl unfollow|r, |cffffd100/polaris unfollow|r, or the Unfollow chat link to stop following."
