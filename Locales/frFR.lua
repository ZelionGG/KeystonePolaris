...
L["MODULES_SUMMARY_LIVE_ROUTE_DESC"] = "Partagez votre route avec les autres joueurs Keystone Polaris en Mythique ou Mythique+, sans écraser leurs routes personnalisées."
...
L["COMMANDS_HELP_SHARE"] = "/kpl share or /polaris share - Partager votre route avec le groupe"
L["COMMANDS_HELP_UNFOLLOW"] = "/kpl unfollow or /polaris unfollow - Arrêter de suivre une route partagée"
...
-- Live Route Sharing
L["KPL_LR_HEADER"] = "Partage de route"
L["KPL_LR_DESC_LONG"] = "Partagez votre route Keystone Polaris avec le groupe en Mythique ou Mythique+. Suivre une route n'écrase jamais vos routes personnalisées sauvegardées. Blizzard bloque les messages addon une fois la clé lancée : partagez avant de lancer la clé, ou après la run."
L["KPL_LR_SHARE"] = "Partager"
L["KPL_LR_SHARE_WITH"] = "Partager avec : %s"
L["KPL_LR_UNFOLLOW"] = "Ne plus suivre"
L["KPL_LR_FOLLOWING"] = "Route de %s suivie. %s"
L["KPL_LR_UNFOLLOWED"] = "Vous ne suivez plus la route partagée."
L["KPL_LR_NOT_FOLLOWING"] = "Vous ne suivez pas de route partagée."
L["KPL_LR_SHARED"] = "Route partagée avec le groupe."
L["KPL_LR_FOLLOWER_ACCEPTED"] = "%s suit votre route."
L["KPL_LR_QUEUED"] = "Route de %s pour %s mise en attente. Confirmation à l'entrée du donjon."
L["KPL_LR_DECODE_FAILED"] = "Impossible de lire la route reçue."
L["KPL_LR_NO_PEERS"] = "Personne d'autre n'a Keystone Polaris."
L["KPL_LR_NOT_IN_DUNGEON"] = "Le partage n'est disponible qu'en donjon Mythique ou Mythique+."
L["KPL_LR_IN_COMBAT"] = "Attendez la fin du combat pour partager une route."
L["KPL_LR_COMM_LOCKDOWN"] = "Blizzard bloque les messages addon pendant une clé Mythique+ en cours. Partagez la route avant de lancer la clé, ou après la run."
L["KPL_LR_COOLDOWN"] = "Attendez %d secondes avant de partager à nouveau."
L["KPL_LR_SHARE_WHILE_FOLLOWING"] = "Arrêtez de suivre la route actuelle avant de partager la vôtre."
L["KPL_LR_DISABLED"] = "Le partage de route est désactivé dans les options."
L["KPL_LR_ENCODE_FAILED"] = "Impossible d'encoder la route à partager."
L["KPL_LR_SEND_FAILED"] = "Impossible d'envoyer la route au groupe."
L["KPL_LR_PROMPT"] = "%s veut partager une route Keystone Polaris pour %s. Suivre cette route ?"
L["KPL_LR_REPLACE_PROMPT"] = "%s veut remplacer la route de %s pour %s. Suivre cette route ?"
L["KPL_LR_ALWAYS_ASK"] = "Toujours demander avant de suivre une route"
L["KPL_LR_ALWAYS_ASK_DESC"] = "Lorsque cette option est activée, même les routes du tank ou du chef de groupe nécessitent une confirmation."
L["KPL_LR_CHAT_COMMAND_INFO"] = "Astuce : utilisez |cffffd100/kpl share|r ou |cffffd100/polaris share|r pour partager votre route, et |cffffd100/kpl unfollow|r, |cffffd100/polaris unfollow|r ou le lien Ne plus suivre dans le chat pour arrêter de suivre."
