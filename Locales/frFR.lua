...
L["PREFIX_COLOR_DESC"] = "Couleur appliquée aux libellés/préfixes (Requis, Actuel, En cours). Le préfixe milestone utilise celle-ci sauf si Couleur de préfixe milestone personnalisée est activée."
L["CUSTOM_MILESTONE_PREFIX_COLOR"] = "Couleur de préfixe milestone personnalisée" -- TODO: "Custom Milestone Prefix Color"
L["CUSTOM_MILESTONE_PREFIX_COLOR_DESC"] = "Utiliser une couleur de préfixe dédiée pour le texte milestone au lieu de la couleur Préfixe globale ci-dessus."
L["MILESTONE_PREFIX_COLOR"] = "Couleur du préfixe" -- TODO: "Prefix Color"
L["MILESTONE_PREFIX_COLOR_DESC"] = "Couleur appliquée au libellé de préfixe du texte milestone."
